  ...
  return (
    <header className="Header">
      <div className="header-col-1">
        <Dropmenu options={!props.selectOptions ? [] : months} selectedOption={props.selectedMonth} optionChanged={props.selectMonthHandler} disabled={props.autoPlay}></Dropmenu>
        <Dropmenu options={!days ? [] : days} selectedOption={props.selectedDay} optionChanged={props.selectDayHandler} disabled={props.autoPlay}></Dropmenu>
